...
ButtonDebounce button(M5_BUTTON_HOME, 250);
...
void callback(char* topic, byte* payload, unsigned int length) {
  ...
  if (error) {
    ...
    Serial.println(record[n].line1);
    record[n].line2 = jsonBuffer["line2"];

//testing
//    Serial.println("record[0]");
//    Serial.println(record[0].line1);
//    Serial.println(record[0].line2);
//    Serial.println("record[1]");
//    Serial.println(record[1].line1);
//    Serial.println(record[1].line2);
